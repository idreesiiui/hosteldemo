    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title"><img src="<?php echo base_url() ?>/assets/images/Iiui-logo1.jpg" style="width:100px; height:100px"> Online Access for Hostel Re-Allotment</h3>
         
                <div class="label-success" style="margin-left:15em; margin-right:10em; padding:10px 50px; width:15em;margin-top:-2em; color:#fff">Female Campus</div><br>
              
          <h5"> Reallotment for <?php echo "<b>(".$semestercode[0]->PROGRAME.') '.'</b>Programe<b>'.' '.$semestercode[0]->SEMCODE."</b>".' and before'; ?></h5>
       
          <h3 style="color: #388F3A;" class="blink" align="center">Re-Allotment Open</h3>
          <p style="color:red">Re-Allotment open on Friday, September 07, 2018 at 12:00 am and will be closed on Monday, September 17, 2018 at 11:59 pm. For more Information <a href="http://www.iiu.edu.pk/wp-content/uploads/downloads/hostel/female/2018/hostel-seat-rewal-040918.jpg" target="_blank">Click here</a> </p>
          <div class="col-md-4">
                <?php
       ...
       <?php $this->load->helper('form'); ?>
        ...
        <div class="modal-body">
         <form role="form" action="<?php echo base_url() ?>freallot/getstudentdetails" method="post" id="regbox">
          <div class="row">
                                <div class="col-md-6">                                
