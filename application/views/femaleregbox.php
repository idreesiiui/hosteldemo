      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title"><img src="<?php echo base_url() ?>/assets/images/Iiui-logo1.jpg" style="width:100px; height:100px"> Online Application for Hostel Registration</h3>
                ...
                <div class="label-success" style="margin-left:15em; margin-right:10em; padding:10px 50px; width:15em;margin-top:-2em; color:#fff">Female Campus</div>
              
          <h5> Hostel Application Semester <?php echo "<b>".$semestercode[0]->SEMCODE."</b>"; ?></h5>
          ...
          <p style="color:red">Hostel Seat Application open on Wednesday, October 23, 2019 at 03:00 PM and will be closed on Wednesday, October 30, 2019 at 05:00 pm. For more Information <a href="<?php echo base_url() ?>/form/notification/girlscampus/HostelapplicationDetails.pdf" target="_blank">Click here</a> </p> 
          <h4>Eligibility Criteria for Hostel Seat</h4>
          <h5 style="font-size:12px;"> New Seat Application for <strong>(BS/MSC/LLB/MBA/M.A/MSC)</strong> Programes from <strong> SPRING-2019 and before</strong></h5>
          
        <h5 style="font-size:12px;"> New Seat Application for <strong>(MS/MPHILL/LLM)</strong> Programes from <strong> FALL-2019 and before</strong></h5>
        <h5 style="font-size:12px;"> New Seat Application for <strong>(PHD)</strong> Programes from <strong> FALL-2019 and before</strong></h5>
        <h5 style="font-size:12px;"> New Seat Application for <strong>(All Overseas Student)</strong> Programes from <strong> FALL-2019 and before</strong></h5>
        <br>
          <div class="col-md-4">
                <?php
       ...
       <?php $this->load->helper('form'); ?>
        ...
        <div class="modal-body">
         <form role="form" action="<?php echo base_url() ?>femalereg/getstudentdetails" method="post" id="regbox">
          <div class="row">
                                <div class="col-md-6">                                
...
Please Enter Registrarion number as per Student Card</div>
        ...
        <!--<a href="<?php //echo base_url() ?>femalereg/girlstudentform">Application New Sutudents (Without Reg No#)</a>-->
