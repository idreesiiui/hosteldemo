            ...
            <div class="col-xs-12">
              ...
              <thead>
                    ...
                    <tr>
                      ...
                      <td><?php if($record->STATUS == 'Pending') {echo '<span style="color:#f39c12;">Process'.'</span>';}elseif($record->STATUS == 'Approved'){ echo '<span style="color:#1D6C3F;">Verified'.'</span>'; }elseif($record->STATUS == 'Cancel') {echo '<span style="color:red;">'.'Cancel</span>';}?></td>
                      ...
                      <td>
                        ...
                        <option value="Approved<?php echo ','.$record->FCHANGE_ID.','.$record->REGNO?>" style="color:green; font-weight:bold">Approved</option>
                        <option value="Pending<?php echo ','.$record->FCHANGE_ID?>" style="color:#FF8C00; font-weight:bold">Pending</option>
                        <option value="Rejected<?php echo ',',$record->FCHANGE_ID?>" style="color:red; font-weight:bold">Rejected</option>
                        </select>
