<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Hostel Seat Inter-Change List Report
        <small>View</small>
      </h1>
    </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Hostel Students Seat Inter-Change List</h3>
                   
                    <form class="form-horizontal" id="searchList" name="validateform" method="post" action="<?php echo base_url() ?>report/reports/seatInterchanges" >
              <div class="box-body">
