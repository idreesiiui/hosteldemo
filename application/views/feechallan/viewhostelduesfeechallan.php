<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Hostel Dues Fee Challan Management
        <small>Search Hostel Dues Challan</small>
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>feechallan/Feechallan/ViewNornalHostelFeeGenrated" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
