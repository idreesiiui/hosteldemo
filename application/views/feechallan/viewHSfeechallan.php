...
<span style="position:absolute;top:94pt;left:150pt" id=f8><?php echo $viewfeeInfo[0]->FEETYPE?></span>
...
<div style="position:absolute;top:238.5pt;left:179.5pt;width:2.8;height:21.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<div style="position:absolute;top:252.0pt;left:36.0pt;width:259.1;height:1.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:263pt;left:36.0pt;width:259.1;height:1.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
...
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:265pt;left:40pt" id=f6><?php  if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo 'Fine Amount'?></span>
<span style="position:absolute;top:265pt;left:212pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo $viewfeeInfo[0]->FINEAMOUNT?></span>
...
<?php } ?>
<span style="position:absolute;top:289pt;left:204pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT) ) $total = $viefeeChallandesc[0]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total;?></span>
...
<span style="position:absolute;top:94pt;left:367pt" id=f8><?php echo $viewfeeInfo[0]->FEETYPE?></span>
...
<div style="position:absolute;top:239.0pt;left:395.5pt;width:2.8;height:21.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<div style="position:absolute;top:252.0pt;left:252.0pt;width:259.1;height:1.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:263.0pt;left:252.0pt;width:259.1;height:1.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
...
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:265pt;left:256pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo 'Fine Amount'?></span>
<span style="position:absolute;top:265pt;left:428pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo $viewfeeInfo[0]->FINEAMOUNT?></span>
<div style="position:absolute;top:265.0pt;left:395.5pt;width:2.8;height:1.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
<span style="position:absolute;top:289pt;left:420pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT) ) $total = $viefeeChallandesc[0]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total;?></span>
...
<span style="position:absolute;top:94pt;left:582pt" id=f8><?php echo $viewfeeInfo[0]->FEETYPE?></span>
...
<div style="position:absolute;top:238.5pt;left:611.5pt;width:2.8;height:22.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<div style="position:absolute;top:252.0pt;left:468.0pt;width:259.1;height:1.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:263.0pt;left:468.0pt;width:259.1;height:1.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div><?php } ?>
...
<span style="position:absolute;top:253pt;left:640pt" id=f6><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT)) echo $viefeeChallandesc[0]->FEEAMOUNT?></span>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:265pt;left:472pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo 'Fine Amount'?></span>
<span style="position:absolute;top:265pt;left:644pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo $viewfeeInfo[0]->FINEAMOUNT?></span>
<div style="position:absolute;top:252.0pt;left:611.5pt;width:2.8;height:19.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div><?php } ?>
<span style="position:absolute;top:289pt;left:636pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT) ) $total = $viefeeChallandesc[0]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total;?></span>
...
<span style="position:absolute;top:94pt;left:798pt" id=f8><?php echo $viewfeeInfo[0]->FEETYPE?></span>
...
<div style="position:absolute;top:238.5pt;left:827.5pt;width:2.8;height:22.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<div style="position:absolute;top:252.0pt;left:684.0pt;width:259.1;height:1.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:263.0pt;left:684.0pt;width:259.1;height:2.0;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div><?php } ?>
<span style="position:absolute;top:252pt;left:688pt" id=f6><?php echo $viefeeChallandesc[0]->FEEDESC?></span>
<span style="position:absolute;top:253pt;left:856pt" id=f6><?php echo $viefeeChallandesc[0]->FEEAMOUNT?></span>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:265pt;left:688pt" id=f6><?php echo 'Fine Amount'?></span>
<span style="position:absolute;top:265pt;left:861pt" id=f6><?php echo $viewfeeInfo[0]->FINEAMOUNT?></span>
<div style="position:absolute;top:252.0pt;left:827.5pt;width:2.8;height:19.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
<span style="position:absolute;top:289pt;left:852pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT) ) $total = $viefeeChallandesc[0]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total;?></span>
