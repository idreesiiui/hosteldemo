<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View Hostel Due Secrity Fee Structure Management
        <small>View</small>
      </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                 <a style="float:left !important" class="btn btn-default" href="<?php echo base_url(); ?>feechallan/Feechallan/viewhostelfeesecurity">Back</a>
                  <a class="btn btn-primary" href="<?php echo base_url(); ?>feechallan/Feechallan/Feesecurity">Add New</a>
                    <div class="col-md-6">
                <?php
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">View Hostel Security Fee Structure List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
              ...
              <thead>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="<?php echo base_url().'feechallan/Feechallan/EditNornalSecurityFeeStructure/'.$record->id ?>"><i class="fa fa-pencil"></i>&nbsp;&nbsp;&nbsp;</a>
