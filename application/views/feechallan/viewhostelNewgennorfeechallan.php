<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View Hostel New Student Fee Challan Generated
        <small>View</small>
      </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                 <a style="float:left !important" class="btn btn-default" href="<?php echo base_url(); ?>feechallan/Feechallan/viewhostelnewfeechallan">Back</a>
                
                  <a class="btn btn-primary" href="<?php echo base_url(); ?>feechallan/Feechallan/addNewFeeschallan">Add New</a>
                    <div class="col-md-6">
                <?php
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">View Hostel Security Fee Challan Generated List</h3>
                    <div class="col-xs-12 text-right" style="top:-2em" >
                    <span class="btn btn-default" style="background-color:#72AFD2; color:#fff">New Hostel Challan Semester: <b><?php echo $csem ?></b></span>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
              ...
              <thead>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="<?php echo base_url().'feechallan/Feechallan/EditNewFeeChallan/'.$record->ID ?>" target="_blank"><i class="fa fa-pencil"></i>&nbsp;&nbsp;&nbsp;</a>
                     <a href="<?php echo base_url().'feechallan/Feechallan/ViewNewFeeChallanDetail/'.$record->ID ?>" target="_blank"><i class="fa fa-print"></i>&nbsp;&nbsp;&nbsp;</a>
                      </td>
                    </tr>
                    <?php
					$sno++;
