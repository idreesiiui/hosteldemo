<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View Hostel Security Fee Challan Generated
        <small>View</small>
      </h1>
    </section>
            ...
            <div class="col-xs-12 text-right">
                <div class="form-group">
                 <a style="float:left !important" class="btn btn-default" href="<?php echo base_url(); ?>feechallan/Feechallan/viewhostelduesfeechallan">Back</a>
                  ...
                  <a class="btn btn-primary" href="<?php echo base_url(); ?>feechallan/Feechallan/addsecurityFeeschallan">Add New</a>
                    <div class="col-md-6">
                <?php
            ...
            <div class="col-xs-12">
              ...
              <thead>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="<?php echo base_url().'feechallan/Feechallan/EditSecurityFeeChallan/'.$record->ID ?>"><i class="fa fa-pencil"></i>&nbsp;&nbsp;&nbsp;</a>
                     <a href="<?php echo base_url().'feechallan/Feechallan/ViewSecurityFeeChallanDetail/'.$record->ID ?>" target="_blank"><i class="fa fa-print"></i>&nbsp;&nbsp;&nbsp;</a>
                      </td>
                    </tr>
                    <?php
					$sno++;
