        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                        <a class="btn btn-primary" style="background-color:#3C8DBC; float:right; margin-right: 2em;" href="<?php echo base_url(); ?>feechallan/newfeechallan/addbulkfeechallan">Add New Fee Challan Regno wise</a>
                        ...
                        <a target="_blank" class="btn btn-primary" style="background-color:#3C8DBC; float:right; margin-right: 2em;" href="<?php echo base_url(); ?>feechallan/newfeechallan/FeeChallanBySem">All ReAllotment Fee Challan</a>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">New Fee Challan Detail List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td>
                       ...
                       <?php 
                        if($record->installment == 'null' || empty($record->installment)){ 
                         
                            echo 'Full Payment';
                         }else{

                            echo ($record->installment == '1') ? 'First Installment':'Second Installment';
                      ...
                      <td>
                      	<a target="_blank" href="<?php echo base_url().'feechallan/NewFeechallan/NeweditFeeChallanByRegno/'.$record->id ?>">
                            <i class="fa fa-pencil"></i> Edit </a> |
                        <a target="_blank" href="<?php echo base_url().'feechallan/NewFeechallan/printFeeChallanByRegno/'.$record->id ?>">
                            <i class="fa fa-print"></i> Print </a>

                        <?php 
                        if($record->publish == 1){ ?>
                         <a target="_blank" class="btn btn-success" href="<?php echo base_url().'feechallan/NewFeechallan/createHostelChallanInstallments/'.$record->id ?>">
                            <i class="fa fa-credit-card"></i> Instalment </a> 
                        <?php } else { ?>
