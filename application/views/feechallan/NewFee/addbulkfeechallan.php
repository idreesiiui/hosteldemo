<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Fee Management
        <small>Add Bulk Fee Challan</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter New Bulk Fee Challan Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" id="Feestructure" action="<?php echo base_url() ?>feechallan/NewFeechallan/getBulkFeechallan" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                               <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="mobile">Current Semester</label>
                                         <input type="text" class="form-control required" id="csem"  name="csem" readonly value="<?php echo $currentsem->semcode ?>" >
                                    </div>
                                </div> 
                                 <div class="col-md-6">
                                    <div class="form-group">
