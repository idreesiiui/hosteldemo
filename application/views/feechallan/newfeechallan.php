<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View New Hostel Student Fee Challan Management
        <small>View</small>
      </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                 <a style="float:left !important" class="btn btn-default" href="<?php echo base_url(); ?>feechallan/Feechallan/addNewFeeschallan">Back</a>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">View New Hostel Student Fee Challan List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                <form role="form" id="addUser" action="<?php echo base_url() ?>feechallan/Feechallan/InsertNewFeeChallan" method="post" role="form">
              ...
              <thead>
                  ...
                  <div class="box-footer">
                            ...
                            <a class="btn btn-primary" style="background-color:#3C8DBC; float:right" href="<?php echo base_url(); ?>feechallan/Feechallan/addNewFeeschallan">Back</a>
                        </div>
                    </form>
                </div><!-- /.box-body -->
