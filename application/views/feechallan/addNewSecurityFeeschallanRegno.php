<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        New Security Fee Challan Regno Wise Management
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter New Security Fee Challan Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" id="addUser" action="<?php echo base_url() ?>feechallan/Feechallan/SubmitNewSecurityFeeChallanregno" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="role">Hostel Security Fee(Amount)</label>
                                       <input type="number" class="form-control required" id="securityfee" name="securityfee" value="5000" required>
                                    </div>
                                </div>
                                 <div class="col-md-6">
                                    <div class="form-group">
