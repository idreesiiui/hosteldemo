...
<div class="jumbotron jumbotron-md jumbotron-fluid mb-3 bg-light" style="background-image: url('<?php echo base_url();?>/assets/frontend/img/usis/headermale.png');background-size:cover;">
	<div class="container text-dark h-100 tofront">
		<div class="row align-items-center justify-content-center text-center text-white mt-5">
			<div class="col-md-10">
				<h1 class="display-3">Step Guide New Application</h1>
            </div>
		</div>
	</div>
</div>
...
<div class="row m-2 bg-white">
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 1: New Application</h4>
                <p class="card-text">
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 2: New Application</h4>
                <p class="card-text">
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 3: New Application</h4>
                <p class="card-text">
                     On Campus Page  (Male or Female)  Click on <b class="text-danger">New Application</b> Section.
                </p>
                  <img src="<?php echo base_url();?>uploads/screenshots/NewApplication/3.newApplication.png"/>
             </div>
        </div>
    </div>
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 4: New Application</h4>
                <p class="card-text">
                    Enter Your <b class="text-danger">Reg. No. As per university card and click on Submitt button</b> to further Proceed.
                </p>
                  <img src="<?php echo base_url();?>uploads/screenshots/NewApplication/4.newApplication.png"/>
             </div>
        </div>
    </div>
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 5: New Application</h4>
                <p class="card-text">
                    On Regsitration Page <b class="text-danger">Read Instruction Carefully</b>.
                </p>
                  <img src="<?php echo base_url();?>uploads/screenshots/NewApplication/5.newApplication.png"/>
             </div>
        </div>
    </div>
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 6: New Application</h4>
                <p class="card-text">
                     Enter all required and neccessary information <b class="text-danger">Note: Please enter accurate information on highlighted sections</b>.
                </p>
                  <img src="<?php echo base_url();?>uploads/screenshots/NewApplication/6.newApplication.png"/>
             </div>
        </div>
    </div>
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 7: New Application</h4>
                <p class="card-text">
                     Enter Person Detail in Case of Emergency. Click on <b class="text-danger">Submitt</b> button.
                </p>
                  <img src="<?php echo base_url();?>uploads/screenshots/NewApplication/7.newApplication.png"/>
             </div>
        </div>
    </div>
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 8: New Application</h4>
                <p class="card-text">
                     Once Registration is done Successfull. An alert will be displayed.
                </p>
                  <img src="<?php echo base_url();?>uploads/screenshots/NewApplication/8.newApplication.png"/>
             </div>
        </div>
    </div>
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 9: New Application</h4>
                <p class="card-text">
                     An Email will be recieved on your registered email address containing <b class="text-danger">Tracking id</b> which will be used for later processing.
                </p>
                  <img src="<?php echo base_url();?>uploads/screenshots/NewApplication/9.newApplication.png"/>
             </div>
        </div>
    </div>
