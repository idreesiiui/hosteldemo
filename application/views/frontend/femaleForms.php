...
<!-- <tr>
	<th scope="row"> 1	</th>
	<td> Hostel Allotment Form </td>
	<td><a href="<?php //echo base_url();?>uploads/notifications/female/forms/hostel_allotment_form-160222.pdf" target="_blank" rel="noopener noreferrer"><img src="<?php //echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr> -->
<tr>
	<th scope="row"> 1	</th>
	<td> Hostel Allotment Form </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/forms/allotment_form_converted.pdf" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
<tr>
	<th scope="row"> 2	</th>
	<td> Seat Renewal Form </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/forms/seat-renewal-form-100217.pdf" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
<tr>
	<th scope="row"> 3	</th>
	<td> Clearence Form  </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/forms/clearance_form_290119.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
<tr>
	<th scope="row"> 4	</th>
	<td> Mess Security Refund Form </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/forms/mess_security_refund_260117.pdf" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
<tr>
	<th scope="row"> 5	</th>
	<td> Permission of Meal Performa</td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/forms/Permission-of-Meal-Performa-280218.pdf" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
<tr>
	<th scope="row"> 6	</th>
	<td> Undertaking </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/forms/undertaking-07022022.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
</tbody>
</table>
</div>
