<div class="container register">
    <div class="row">
         <div class="col-md-4 register-left">
                ...
                <small class="btn btnRegister d-block mt-2 text-center"><a class="text-white" href="<?php echo base_url();?>femalePage">Back to Home Screen</a></small>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="row register-heading">
                            ...
                            ?>
                          	<?php //echo '<img src ="data:image/jpeg;base64,'.base64_encode($blobimg).'" class="mt-1 ml-5 avatar"/>';?>
                         
                         	<?php //} else {?>
                                <!--<img src="<?php //echo base_url();?>/assets/frontend/img/usis/avatar_female.png" alt="Avatar" class="mt-1 ml-5 avatar">-->
                        	<?php //}?>
                        </div>
                        <div class="col-md-11 pull-right" style="float:right; top: 40px;">
								<?php
                  ...
                  <form role="form" class="row register-form " id="signup" action="<?php echo base_url()?>femalereg/AddSignup" method="post">           
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select class="form-control required" id="province" name="province">
                                 <?php 
									...
									{
									?>
                                    <option value="<?php echo $StudentInfo[0]->COUNTRY ?>" ><?php echo $StudentInfo[0]->COUNTRY?></option>
                                    <option value="Overseas Pakistani">Overseas Pakistani</option>
