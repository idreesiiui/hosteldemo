...
<p class="text-center">We try our best to make IIUI hostels your home-away-from-home. Please reach out to the hostel management if you have any questions or feedback.</p>
</div>
<!-- Card Overlay -->
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-header bg-success text-white">
          ...
          Online Application for Boys Hostels Registration
          </h5>
          <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
        </div>
...
All students of <?php echo $semestercode[0]->SEMESTEROPENREG; ?>  and Spring 2024 semester</br> shall apply in link below  
                ...
                //echo "<b>(".$semestercode[0]->PROGRAME.") ".$semestercode[0]->SEMESTEROPENREG."</b>"; 
    ...
    <div class="pt-5 pb-5 col-md-3  card bg-purple overlay overlay-white text-white  border-white" > <div class="d-flex align-items-center text-center">
            <div class="card-body">
                ...
                <?php 
					if(!empty($semestercode[0]->IS_ACTIVE) && $semestercode[0]->IS_ACTIVE == 1 && $semestercode[0]->GENDER == 'Male' && $semestercode[0]->REALLOTSTATUS == 1 )
					{
				 ?>
    ...
    <div class="pt-5 pb-5 col-md-3  card bg-danger overlay overlay-white text-white border-white"> <div class="d-flex align-items-center text-center">
            <div class="card-body">
               ...
               <?php  }else{ ?>
                ...
                <button class="btn btn-white btn-round" data-toggle="modal" data-target="#allotmentModal">
                <i class="fas fa-hand-pointer"></i> Click Here
                </button>
  ...
  <div class="modal fade" id="allotmentModal">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-header bg-success text-white">
          <h5 class="modal-title"><img src="<?php echo base_url() ?>/assets/frontend/img/usis/iiui-logo.png" width=60; height=60 />
           Allotment of Hostel Seat is closed!
          </h5>
          <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
        </div>
      ...
      <!--   <p>Due to a shortage of hostel seats, initially Common Room seats will be available for Fall 2023 BS students. Allotment is subject to <strong><u><i>"first come first serve" </i></u></strong>on available hostel seats only. </p>
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
          <!-- <a href="<?php echo base_url() ?>login"><button class="btn btn-success">Apply Now</button></a> -->
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
