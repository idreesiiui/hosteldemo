...
<div class="container">
	...
	<div class="collapse navbar-collapse m-2" id="navbarNavDropdown-1">
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"  id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Related Links</a>
...
HEADER
--------------------------------------->
<div class="jumbotron jumbotron-md jumbotron-fluid mb-3 bg-light" style="background-image: url('<?php echo base_url();?>/assets/frontend/img/usis/headerfemale.png');background-size:cover;height: 500px;">
...
<div class="m-3 p-3 bg-white">
  <h2 class="bg-white text-success font-weight-bold text-center">Welcome to Girls Hostels</h2>

<p >First of all, I warmly welcome both fresh and continuing students of International Islamic University Islamabad.<br/>
We have a mega structure of Female Hostels, consisting of seven female hostel blocks with the capacity of approx. twenty five hundred (2500) students. We always try to facilitate students and give them a homely, educational and healthy environment.<br/>
The main purpose of a boarder staying at a hostel is to study. I, therefore, urge you to devote your time and attention to your academic work. Take your lectures seriously, work on your assignments and devote yourself to further reading by spending quality time in the library.<br/>
Remember, our hostels, like any human society, are governed by rules and regulations. We try our best to create a conducive environment for you, and in return, expect that you would also endeavor to abide by the rules.<br/> Please make sure to find some time to read your hostel rules and regulations carefully attached with your allotment forms.<br/>
Once again, I welcome all of you and wish you a happy and successful time at the IIUI. May every semester of your stay here be fruitful and memorable for you all!<br/> Thank you!
</p>
<p class="col-md-12 pull-right" style="text-align: right;"><b>Dr.Humaira Ishfaq</b><br />Provost  Girls Hostels</p>
</div>
<div class="row m-2 bg-white">
    <div class="pt-5 pb-5 col-md-4  card bg-cyan overlay overlay-white text-white  border-white" > <div class="d-flex align-items-center text-center">
            <div class="card-body">
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p style="color:red">For more information and latest update please visit at <a href="http://www.iiu.edu.pk/?page_id=17200">Click here</a> </p>
        </div>
  ...
  <div class="modal fade" id="newappopenModal">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
              ...
              <h6> Registration for <b>(Foreign Students)</b><?php echo "<b>".$semestercode[0]->SEMESTEROPENREG."</b>"; ?></h6>
          ...
          <form role="form" action="<?php echo base_url() ?>appformfemale" method="post" id="regbox">
          <div class="row">
                <div class="col-md-6">                                
    ...
    <div class="pt-5 pb-5 col-md-4  card bg-purple overlay overlay-white text-white  border-white" > <div class="d-flex align-items-center text-center">
            <div class="card-body">
                <h3 class="card-title">Reallotment</h3>
                <p class="card-text">
                     Apply for Seat Renewal.
                </p>
                <?php 
					if(!empty($semestercode[0]->IS_ACTIVE) && $semestercode[0]->IS_ACTIVE == 1 && $semestercode[0]->GENDER == 'Female' && $semestercode[0]->REALLOTSTATUS == 1)
					{
                        // var_dump($semestercode[0]->IS_ACTIVE);
                        // var_dump($semestercode[0]->GENDER);
                        // var_dump($semestercode[0]->APPSTATUS);
				 ?>
  ...
  <div class="modal fade" id="renewcloseModal">
    ...
    <div class="pt-5 pb-5 col-md-4  card bg-info overlay overlay-white text-white  border-white" > <div class="d-flex align-items-center text-center">
            <div class="card-body">
                ...
                <?php 
				if(!empty($semestercode) && $semestercode[0]->SEATCHANGESTATUS == 1 && $semestercode[0]->GENDER == 'Female')
				{
				 ?>
			    <a href="<?php echo base_url() ?>login" class="btn btn-white btn-round">
                <i class="fas fa-hand-pointer"></i> Click Here
...
<!--<div class="bg-light p-4 aos-init aos-animate" id="contactus"  data-aos="fade-up">
	...
	<div class="row form-group">
		<div class="col-md-4 mb-4">
            ...
            <input type="hidden" class="form-control" name="type" required  value="female">
		</div>
		<div class="col-md-4 mb-4">
...
<div class="container">
	<div class="row  mb-1">
		...
		<li>
          <a class="text-gray" href="<?php echo base_url();?>femaleLists"><i class="fa fa-list text-success"></i> Lists</a></li>
          <li><a class="text-gray" href="<?php echo base_url();?>femaleNotifications"><i class="fa fa-list text-success"></i> Notifications</a></li>
          <li><a class="text-gray" href="<?php echo base_url();?>femaleForms"><i class="fa fa-list text-success"></i> Forms</a></li>
			</ul>
		</div>
		<div class="col-md-4">
