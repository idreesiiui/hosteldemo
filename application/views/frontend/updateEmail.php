...
<div class="d-md-flex h-md-100 align-items-center">
	...
	<div class="col-md-6 p-0 bg-white h-md-100 loginarea">
		<div class="d-md-flex align-items-center h-md-100 p-4 justify-content-center" >
			<form action="<?php echo base_url();?>login/emailupdateStudent" method="post" id="updtemailForm" class="border rounded p-4"
             style="min-width: 50%;">
				<h4 class="mb-4 text-success text-center">Update Email</h4>
				<?php
				...
				<div class="form-group has-feedback">
		            <input type="text" class="form-control" name="regno" value="<?php echo $emailinfo[0]->REGNO?>" required readonly />
