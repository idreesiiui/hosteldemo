    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 align="center"> Registration for <?php echo $campus; ?> Hostel IIUI closed</h4>
          
          <h3 style="color: #F30;" class="blink" align="center">Registration Closed</h3>
       ...
       <?php $this->load->helper('form'); ?>
        ...
        <!--<a target="_blank" style="float:left;" href="<?php //echo base_url() ?>list/female/BSF18.pdf"><button class="btn btn-success">BS FALL-2018 New Allotment list</button></a>-->
        <!--<a  target="_blank" href="<?php //echo base_url() ?>list/female/MSF18.pdf"><button class="btn btn-success">MS FALL-2018 New Allotment list</button></a>-->
        <a href="<?php echo base_url() ?>regbox/malemain" style="float:left"><button class="btn btn-primary">Back</button></a>
        <a href="<?php echo base_url() ?>login"><button class="btn btn-success">New Student Signup / Login</button></a>
