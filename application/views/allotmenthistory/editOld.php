...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Seat Allotment History Management
        <small>Edit Seat Allotment History</small>
      </h1>
    </section>
            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="editallotment" action="<?php echo base_url() ?>allotmenthistory/allotmenthistory/editallotment" method="post" role="form">
                        <div class="box-body">
                         <div class="row">
                         <div class="col-md-2" style="margin-top:-3em; float:right;">
                                    <div class="form-group">
                  <?php if(!empty($allotInfo[0]->ALLOTMENTHISTORY_ID)){ 
                            ...
                            <div class="row">
                                   <div class="col-md-2">                                
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control required" id="allotmentid" name="allotmentid" maxlength="10" readonly value="<?php echo $allotInfo[0]->ALLOTMENTHISTORY_ID?>">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="fname"  name="fname" maxlength="120" readonly value="<?php echo $stPerInfo[0]->FATHERNAME?>">
                                         ...
                                         <input type="hidden" class="form-control required" id="caddress"  name="caddress" maxlength="120" readonly value="<?php if(isset($stPerInfo[0]->COUNTRY)) echo $stPerInfo[0]->PREADD?>">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control required" id="email"  name="email" maxlength="120"  value="<?php if(isset($allotemail[0]->email)) echo $allotemail[0]->email ?>" >
