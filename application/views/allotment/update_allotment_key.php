            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
 <form role="form" id="fregform" action="<?php echo base_url();?>allotment/Allotment/UpdateKeyAndAllotmentHistory" method="post" role="form">
                        <div class="box-body">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="allotmentid" name="allotmentid" value="<?php echo $userInfo[0]->ALLOTMENT_ID;?>">
                                    </div>                                    
                                </div>
                                 <div class="col-md-6">                                
                                    <div class="form-group">
