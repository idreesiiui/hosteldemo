...
<html lang="en">
<head>
  <title>Online Application for Seat Change/Interchange Registration</title>
  <meta charset="utf-8">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title"><img src="<?php echo base_url() ?>/assets/images/Iiui-logo1.jpg" style="width:100px; height:100px"> Online Application for Seat Change</h3>
          <h4 align="center"> Application for <?php echo $campus; ?> Hostel Seat Change IIUI closed</h4>
          
          <h3 style="color: #F30;" class="blink" align="center">Application Closed</h3>
       ...
       <?php $this->load->helper('form'); ?>
        ...
        <a href="<?php echo base_url() ?>regbox/malemain"><button class="btn btn-primary">Back</button></a>
