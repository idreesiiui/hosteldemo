  ...
  <body class="login-page">
    <div class="signup-box" style="margin-top: 0px;">
      ...
      <div class="signup-box-body" style="margin-top: -25px;">
       ...
       <h4 class="login-box-msg" style="text-decoration:underline;">Female Hostel Re-Allotment for <?php echo '<strong>'.$semestercode[0]->PROGRAME.'</strong>'.' '.'Programe'.' '.'<strong>'.$semestercode[0]->SEMCODE.'</strong>'?> </strong></h4>
        ...
        <form role="form" id="signup" action="<?php echo base_url();?>freallot/AddSignup" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                ...
                                <div class="col-md-6">                                
                                    ...
                                    <label for="gender">Gender</label>
                                      <input type="text" class="form-control required" id="gender" name="gender" value="<?php echo $StudentInfo[0]->GENDER ?>" readonly>
                                    </div> 
                                </div>
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="role">Faculty</label>
                                        <input type="text" class="form-control required" id="faculty" name="faculty" maxlength="128" value="<?php echo $Studentacad[0]->FACULTY ?>" readonly> 
                                    </div>
                                </div>
                                </div>
                                <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="dept" name="dept" maxlength="128" value="<?php echo $Studentacad[0]->DEPARTMENTNAME ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="programe">Programe</label>
                                      <input type="text" class="form-control required" id="programe" name="programe" maxlength="125" value="<?php echo $Studentacad[0]->PROGRAME ?>" readonly> 
                                    </div>
                                </div>
                                </div>
                                <div class="row">
