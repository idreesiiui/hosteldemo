...
<html>
  <head>
    <meta charset="UTF-8">
    <title>IIUI Hostel Managment System | User System Forgot Email</title>
  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Regno as per University Card</p>
        ...
        <form action="<?php echo base_url(); ?>login/GetRegno" method="post">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Card Regno" name="regno" required />
