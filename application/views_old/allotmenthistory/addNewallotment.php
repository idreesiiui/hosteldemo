                                ...
                                <input type="text" class="form-control required" id="preadd"  name="preadd" maxlength="120">
                                  ...
                                  <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control required" id="email"  name="email" maxlength="120"   >
                     ...
                     <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control required" id="semcode"  name="semcode" maxlength="120" value="Spring-2018"> 
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
