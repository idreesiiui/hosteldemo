    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12 text-right">
                ...
                <a class="btn btn-default" href="<?php echo base_url(); ?>reallotment/ReAllotment/viewreallotmentDetail">Back</a>
                <div class="col-md-6">
                <?php
              ...
              <thead>
                    ...
                    <tr>
					 ...
					 if($record->IS_SUBMIT == 1)
                      ...
                      <td>
                          <a href="<?php echo base_url().'reallotment/ReAllotment/reverallotmentdetail/'.$record->DEFAULT_ID; ?>"><i class="fa fa-arrow-circle-right">Revert</i>&nbsp;&nbsp;&nbsp;</a>
