<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Hostel Security Fee Challan Management
        <small>Search Hostel Security Challan</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Search Hostel Fee Security Challan Details</h3>
                        <a class="btn btn-primary" style="background-color:#3C8DBC; float:right" href="<?php echo base_url(); ?>feechallan/Feechallan/addsecurityFeeschallan">Add New</a>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" id="addUser" action="<?php echo base_url() ?>feechallan/Feechallan/ViewSecurityHostelFeeGenrated" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
