...
if(!empty($viewfee))
{
	foreach($viewfee as $viewfeeInfo)
	{
?>
...
<div style="position:absolute;top:32.0pt;left:22.5pt;width:289.5;height:400;padding-top:427.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"><table></table></div>
...
<span style="position:absolute;top:49pt;left:64pt" id=f3><?php echo $viewfeeInfo->BANKNAME?></span>
...
<span style="position:absolute;top:67pt;left:153pt" id=f5><?php echo $viewfeeInfo->BANKACCNO?></span>
<style>#f6{font:8pt Arial;color:#000000}</style>
<span style="position:absolute;top:90pt;left:76pt" id=f6><?php echo $viewfeeInfo->CHALLANNO?></span>
...
<div style="position:absolute;top:81pt;left:85pt" id=f7>Semster:<span id=f1a81a85><?php echo $viewfeeInfo->SEMCODE?></span></div>
...
<span style="position:absolute;top:103pt;left:180pt" id=f9><?php echo $viewfeeInfo->CHALLANDUEDATE?></span>
...
<span style="position:absolute;top:103pt;left:81pt" id=f7><?php echo $viewfeeInfo->CHALLANDATE?></span>
...
<span style="position:absolute;top:117pt;left:67pt" id=f10><?php echo $viewfeeInfo->REGNO?></span>
<span style="position:absolute;top:135pt;left:36pt" id=f7>Name:</span>
<span style="position:absolute;top:135pt;left:62pt" id=f4><?php echo $viewfeeInfo->STUDENTNAME?></span>
...
<span style="position:absolute;top:148pt;left:90pt" id=f11><?php echo $viewfeeInfo->FATHERNAME?></span>
<span style="position:absolute;top:162pt;left:36pt" id=f7>Faculty:</span>
<span style="position:absolute;top:162pt;left:67pt" id=f11><?php echo $viewfeeInfo->FACULTY?></span>
<span style="position:absolute;top:175pt;left:36pt" id=f7>Department:</span>
<span style="position:absolute;top:175pt;left:90pt" id=f11><?php echo $viewfeeInfo->DEPNAME?></span>
<span style="position:absolute;top:189pt;left:36pt" id=f7>Program:</span>
<span style="position:absolute;top:189pt;left:76pt" id=f11><?php echo $viewfeeInfo->PROGRAME?></span>
<span style="position:absolute;top:202pt;left:36pt" id=f7>Batch:</span>
<span style="position:absolute;top:202pt;left:63pt" id=f11>BS in <?php echo $viewfeeInfo->DEPNAME." ".$viewfeeInfo->BATCHNAME?></span>
...
<span style="position:absolute;top:252pt;left:40pt" id=f6><?php echo $viewfeeInfo->FEEDESC?></span>
<span style="position:absolute;top:252pt;left:202pt" id=f6>61200</span>
...
<span style="position:absolute;top:265pt;left:197pt" id=f12>61200</span>
<span style="position:absolute;top:265pt;left:103pt" id=f12>Total Amount:</span>
...
<div style="position:absolute;top:32.0pt;left:238.5pt;width:289.5;height:400;padding-top:427.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
...
<span style="position:absolute;top:49pt;left:280pt" id=f3><?php echo $viewfeeInfo->BANKNAME?></span>
...
<span style="position:absolute;top:67pt;left:369pt" id=f5><?php echo $viewfeeInfo->BANKACCNO?></span>
<style>#f1a81a301{color:#000000;}</style>
<div style="position:absolute;top:81pt;left:301pt" id=f7>Semster:<span id=f1a81a301><?php echo $viewfeeInfo->SEMCODE?></span></div>
<span style="position:absolute;top:94pt;left:292pt" id=f6><?php echo $viewfeeInfo->CHALLANNO?></span>
...
<span style="position:absolute;top:108pt;left:396pt" id=f9><?php echo $viewfeeInfo->CHALLANDUEDATE?></span>
...
<span style="position:absolute;top:108pt;left:297pt" id=f7><?php echo $viewfeeInfo->CHALLANDATE?></span>
<span style="position:absolute;top:121pt;left:252pt" id=f7>RegNo:</span>
<span style="position:absolute;top:121pt;left:283pt" id=f10><?php echo $viewfeeInfo->REGNO?></span>
<span style="position:absolute;top:135pt;left:252pt" id=f7>Name:</span>
<span style="position:absolute;top:135pt;left:278pt" id=f4><?php echo $viewfeeInfo->STUDENTNAME?></span>
<span style="position:absolute;top:148pt;left:252pt" id=f7>Father Name:</span>
<span style="position:absolute;top:148pt;left:306pt" id=f11><?php echo $viewfeeInfo->FATHERNAME?></span>
<span style="position:absolute;top:162pt;left:252pt" id=f7>Faculty:</span>
<span style="position:absolute;top:162pt;left:283pt" id=f11><?php echo $viewfeeInfo->FACULTY?></span>
<span style="position:absolute;top:175pt;left:252pt" id=f7>Department:</span>
<span style="position:absolute;top:175pt;left:306pt" id=f11><?php echo $viewfeeInfo->DEPNAME?></span>
<span style="position:absolute;top:189pt;left:252pt" id=f7>Program:</span>
<span style="position:absolute;top:189pt;left:292pt" id=f11><?php echo $viewfeeInfo->PROGRAME?></span>
<span style="position:absolute;top:202pt;left:252pt" id=f7>Batch:</span>
<span style="position:absolute;top:202pt;left:279pt" id=f11>BS in <?php echo $viewfeeInfo->DEPNAME?> F16 (09 F)</span>
...
<span style="position:absolute;top:252pt;left:256pt" id=f6>University Dues/Tuition Fee     </span>
<span style="position:absolute;top:252pt;left:418pt" id=f6>61200</span>
...
<span style="position:absolute;top:265pt;left:413pt" id=f12>61200</span>
<span style="position:absolute;top:265pt;left:319pt" id=f12>Total Amount:</span>
<div style="position:absolute;top:301.0pt;left:247.5pt;width:265.5;height:2.8;padding-top:-4.8;font:0pt Arial;border-width:1.4 0 0 0; border-style:solid;border-color:#000000;"></div>
...
<div style="position:absolute;top:32.0pt;left:454.5pt;width:289.5;height:394;padding-top:433.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
...
<span style="position:absolute;top:49pt;left:496pt" id=f3><?php echo $viewfeeInfo->BANKNAME?></span>
...
<span style="position:absolute;top:67pt;left:585pt" id=f5><?php echo $viewfeeInfo->BANKACCNO?></span>
<style>#f1a81a517{color:#000000;}</style>
<div style="position:absolute;top:81pt;left:517pt" id=f7>Semster:<span id=f1a81a517><?php echo $viewfeeInfo->SEMCODE?></span></div>
<span style="position:absolute;top:94pt;left:508pt" id=f6><?php echo $viewfeeInfo->CHALLANNO?></span>
...
<span style="position:absolute;top:108pt;left:612pt" id=f9><?php echo $viewfeeInfo->CHALLANDUEDATE?></span>
...
<span style="position:absolute;top:108pt;left:513pt" id=f7><?php echo $viewfeeInfo->CHALLANDATE?></span>
<span style="position:absolute;top:121pt;left:468pt" id=f7>RegNo:</span>
<span style="position:absolute;top:121pt;left:499pt" id=f10><?php echo $viewfeeInfo->REGNO?></span>
<span style="position:absolute;top:135pt;left:468pt" id=f7>Name:</span>
<span style="position:absolute;top:135pt;left:494pt" id=f4><?php echo $viewfeeInfo->STUDNAME?></span>
<span style="position:absolute;top:148pt;left:468pt" id=f7>Father Name:</span>
<span style="position:absolute;top:148pt;left:522pt" id=f11><?php echo $viewfeeInfo->FATHERNAME?></span>
<span style="position:absolute;top:162pt;left:468pt" id=f7>Faculty:</span>
<span style="position:absolute;top:162pt;left:499pt" id=f11><?php echo $viewfeeInfo->FACULTY?></span>
<span style="position:absolute;top:175pt;left:468pt" id=f7>Department:</span>
<span style="position:absolute;top:175pt;left:522pt" id=f11><?php echo $viewfeeInfo->DEPNAME?></span>
<span style="position:absolute;top:189pt;left:468pt" id=f7>Program:</span>
<span style="position:absolute;top:189pt;left:508pt" id=f11><?php echo $viewfeeInfo->PROGRAME?></span>
<span style="position:absolute;top:202pt;left:468pt" id=f7>Batch:</span>
<span style="position:absolute;top:202pt;left:495pt" id=f11><?php echo $viewfeeInfo->PROTITTLE?> in <?php echo $viewfeeInfo->DEPNAME?> F16 (09 F)</span>
...
<span style="position:absolute;top:252pt;left:472pt" id=f6>University Dues/Tuition Fee     </span>
<span style="position:absolute;top:252pt;left:634pt" id=f6>61200</span>
...
<span style="position:absolute;top:265pt;left:629pt" id=f12>61200</span>
<span style="position:absolute;top:265pt;left:535pt" id=f12>Total Amount:</span>
...
<div style="position:absolute;top:32.0pt;left:670.5pt;width:289.5;height:394;padding-top:433.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
...
<span style="position:absolute;top:49pt;left:712pt" id=f3><?php echo $viewfeeInfo->BANKNAME?></span>
...
<span style="position:absolute;top:67pt;left:801pt" id=f5><?php echo $viewfeeInfo->BANKACCNO?></span>
<style>#f1a81a733{color:#000000;}</style>
<div style="position:absolute;top:81pt;left:733pt" id=f7>Semster:<span id=f1a81a733><?php echo $viewfeeInfo->SEMCODE?></span></div>
<span style="position:absolute;top:94pt;left:724pt" id=f6><?php echo $viewfeeInfo->CHALLANNO?></span>
...
<span style="position:absolute;top:108pt;left:828pt" id=f9><?php echo $viewfeeInfo->CHALLANDUEDATE?></span>
...
<span style="position:absolute;top:108pt;left:729pt" id=f7><?php echo $viewfeeInfo->CHALLANDATE?></span>
<span style="position:absolute;top:121pt;left:684pt" id=f7>RegNo:</span>
<span style="position:absolute;top:121pt;left:715pt" id=f10><?php echo $viewfeeInfo->REGNO?></span>
<span style="position:absolute;top:135pt;left:684pt" id=f7>Name:</span>
<span style="position:absolute;top:135pt;left:710pt" id=f4><?php echo $viewfeeInfo->STUDENTNAME?></span>
<span style="position:absolute;top:148pt;left:684pt" id=f7>Father Name:</span>
<span style="position:absolute;top:148pt;left:738pt" id=f11><?php echo $viewfeeInfo->FATHERNAME?></span>
<span style="position:absolute;top:162pt;left:684pt" id=f7>Faculty:</span>
<span style="position:absolute;top:162pt;left:715pt" id=f11><?php echo $viewfeeInfo->FACULTY?></span>
<span style="position:absolute;top:175pt;left:684pt" id=f7>Department:</span>
<span style="position:absolute;top:175pt;left:738pt" id=f11><?php echo $viewfeeInfo->DEPNAME?></span>
<span style="position:absolute;top:189pt;left:684pt" id=f7>Program:</span>
<span style="position:absolute;top:189pt;left:724pt" id=f11><?php echo $viewfeeInfo->PROGRAME?></span>
<span style="position:absolute;top:202pt;left:684pt" id=f7>Batch:</span>
<span style="position:absolute;top:202pt;left:711pt" id=f11>BS in <?php echo $viewfeeInfo->DEPNAME?> F16 (09 F)</span>
...
<span style="position:absolute;top:252pt;left:688pt" id=f6>University Dues/Tuition Fee     </span>
<span style="position:absolute;top:252pt;left:850pt" id=f6>61200</span>
...
<span style="position:absolute;top:265pt;left:845pt" id=f12>61200</span>
<span style="position:absolute;top:265pt;left:751pt" id=f12>Total Amount:</span>
<div style="position:absolute;top:301.0pt;left:679.5pt;width:265.5;height:2.8;padding-top:-4.8;font:0pt Arial;border-width:1.4 0 0 0; border-style:solid;border-color:#000000;"></div>
...
<span style="position:absolute;top:517pt;left:40pt" id=f14>IIUI-Hostel&nbsp;</span>
<span style="position:absolute;top:517pt;left:72pt" id=f14>&nbsp;&nbsp;(Auto Generated)</span>
<span style="position:absolute;top:517pt;left:261pt" id=f14>IIUI-Hostel&nbsp;</span>
<span style="position:absolute;top:517pt;left:292pt" id=f14>&nbsp;&nbsp;(Auto Generated)</span>
<span style="position:absolute;top:517pt;left:477pt" id=f14>IIUI-Hostel&nbsp;</span>
<span style="position:absolute;top:517pt;left:508pt" id=f14>&nbsp;&nbsp;(Auto Generated)</span>
<span style="position:absolute;top:517pt;left:693pt" id=f14>IIUI-Hostel&nbsp;</span>
<span style="position:absolute;top:517pt;left:724pt" id=f14>&nbsp;&nbsp;(Auto Generated)</span>
<style>#f15{font:7pt Arial;color:#000000; margin-left:-15px}</style>
<span style="position:absolute;top:517pt;left:162pt" id=f15><?php echo date("j F, Y, g:i a");?></span>
<span style="position:absolute;top:517pt;left:126pt" id=f14>Printed On</span>
<span style="position:absolute;top:517pt;left:382pt" id=f15><?php echo date("j F, Y, g:i a");?></span>
<span style="position:absolute;top:517pt;left:346pt" id=f14>Printed On</span>
<span style="position:absolute;top:517pt;left:598pt" id=f15><?php echo date("j F, Y, g:i a");?></span>
<span style="position:absolute;top:517pt;left:562pt" id=f14>Printed On</span>
<span style="position:absolute;top:517pt;left:814pt" id=f15><?php echo date("j F, Y, g:i a");?></span>
<span style="position:absolute;top:517pt;left:778pt" id=f14>Printed On</span>
...
{
echo '<i style="color:red;font-size:20px;font-family:calibri ;">Sorry Hostel Fee Challan is not genrated by Fee Section for more info contact Fee Section & Hostel Admin.</i><br><br> You will be redirect to previous page shortly !';


header( "refresh:7;url=http://localhost/hostel/feechallan/Feechallan/viewfeeDetail" );
