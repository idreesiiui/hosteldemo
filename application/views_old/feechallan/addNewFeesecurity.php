<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Fee Security Structure
        <small>Add / Edit Security Structure</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Fee Security Structure Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" id="addUser" action="<?php echo base_url() ?>feechallan/Feechallan/addSecurityStructure" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="gender">Nationality</label>
                                        <select class="form-control required" id="snationality" name="nationality" required>
                               ...
                               <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="sprogramelevel" name="programelevel" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="feestucture">Security Fee Structure Semester</label>
                                        <input type="text" class="form-control required" id="feestructure" name="feestructure" maxlength="20" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-primary" style="background-color:#3C8DBC; float:right" href="<?php echo base_url(); ?>feechallan/Feechallan/viewhostelfeesecurity">Back</a>
                        </div>
                    </form>
                </div>
            </div>
