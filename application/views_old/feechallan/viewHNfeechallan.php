...
<span style="position:absolute;top:37pt;left:80pt" id=f3>
  <img src="<?php echo base_url(); ?>assets/dist/img/feechallan/<?php echo $BankInfo->LOGONAME?>" style="width:130px; height:35px">
  <?php echo $BankInfo->BANKNAME?>
</span>
...
<div style="position:absolute;top:290.0pt;left:36.0pt;width:259.1;height:4.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>

<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:290pt;left:36.0pt;width:259.1;height:19.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
...
<span style="position:absolute;top:279pt;left:209pt" id=f6><?php if(isset($viefeeChallandesc[2]->FEEAMOUNT)) echo $viefeeChallandesc[2]->FEEAMOUNT?></span>
<span style="position:absolute;top:291pt;left:40pt" id=f6><?php  if(isset($viefeeChallandesc[3]->FEEDESC)) echo $viefeeChallandesc[3]->FEEDESC?></span>
<span style="position:absolute;top:292pt;left:209pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEAMOUNT)) echo $viefeeChallandesc[3]->FEEAMOUNT?></span>
...
<div style="position:absolute;top:250.0pt;left:179.5pt;width:2.8;height:57.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>

<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:305pt;left:40pt" id=f6><?php  if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo 'Fine Amount'?></span>
<span style="position:absolute;top:305pt;left:214pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo $viewfeeInfo[0]->FINEAMOUNT?></span>
<div style="position:absolute;top:252.0pt;left:179.5pt;width:2.8;height:73.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<?php } ?>
<span style="position:absolute;top:320pt;left:204pt" id=f12>
  <?php 

  if(isset($viefeeChallandesc[0]->FEEAMOUNT) && isset($viefeeChallandesc[1]->FEEAMOUNT) && isset($viefeeChallandesc[2]->FEEAMOUNT) && isset($viefeeChallandesc[3]->FEEAMOUNT)){
   $total = $viefeeChallandesc[0]->FEEAMOUNT + $viefeeChallandesc[1]->FEEAMOUNT + 
   $viefeeChallandesc[2]->FEEAMOUNT + $viefeeChallandesc[3]->FEEAMOUNT + $viewfeeInfo[0]->FINEAMOUNT;
    echo $total;
}else if(isset($viefeeChallandesc[0]->FEEAMOUNT) && isset($viefeeChallandesc[1]->FEEAMOUNT)){
  $total = $viefeeChallandesc[0]->FEEAMOUNT + $viefeeChallandesc[1]->FEEAMOUNT
    + $viewfeeInfo[0]->FINEAMOUNT;
   echo $total;
}
...
<span style="position:absolute;top:320pt;left:103pt" id=f12>Total Amount:</span>
...
<div style="position:absolute;top:239.0pt;left:395.5pt;width:2.8;height:74.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
...
<div style="position:absolute;top:290.0pt;left:252.0pt;width:259.1;height:4.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>


<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:304.0pt;left:252.0pt;width:259.1;height:1.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
...
<span style="position:absolute;top:280pt;left:425pt" id=f6><?php if(isset($viefeeChallandesc[2]->FEEAMOUNT)) echo $viefeeChallandesc[2]->FEEAMOUNT?></span>
<span style="position:absolute;top:292pt;left:256pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEDESC)) echo $viefeeChallandesc[3]->FEEDESC?></span>
<span style="position:absolute;top:292pt;left:425pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEAMOUNT)) echo $viefeeChallandesc[3]->FEEAMOUNT?></span>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:305pt;left:256pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo 'Fine Amount'?></span>
<span style="position:absolute;top:305pt;left:430pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo $viewfeeInfo[0]->FINEAMOUNT?></span>
<div style="position:absolute;top:265.0pt;left:395.5pt;width:2.8;height:54.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
<span style="position:absolute;top:320pt;left:420pt" id=f12>
  <?php 
  if(isset($viefeeChallandesc[0]->FEEAMOUNT) && isset($viefeeChallandesc[1]->FEEAMOUNT) && isset($viefeeChallandesc[2]->FEEAMOUNT) && isset($viefeeChallandesc[3]->FEEAMOUNT)){
    $total = $viefeeChallandesc[0]->FEEAMOUNT + $viefeeChallandesc[1]->FEEAMOUNT + $viefeeChallandesc[2]->FEEAMOUNT + $viefeeChallandesc[3]->FEEAMOUNT + $viewfeeInfo[0]->FINEAMOUNT; 
  echo $total;
  }else if(isset($viefeeChallandesc[0]->FEEAMOUNT) && isset($viefeeChallandesc[1]->FEEAMOUNT))
  $total = $viefeeChallandesc[0]->FEEAMOUNT + $viefeeChallandesc[1]->FEEAMOUNT + $viewfeeInfo[0]->FINEAMOUNT; 
  echo $total;

  ?>
    
  </span>
<span style="position:absolute;top:320pt;left:325pt" id=f12>Total Amount:</span>
...
<div style="position:absolute;top:238.5pt;left:611.5pt;width:2.8;height:72.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
...
<div style="position:absolute;top:277.0pt;left:468.0pt;width:259.1;height:19.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
...
<span style="position:absolute;top:278pt;left:640pt" id=f6><?php if(isset($viefeeChallandesc[2]->FEEAMOUNT)) echo $viefeeChallandesc[2]->FEEAMOUNT?></span>
<span style="position:absolute;top:290pt;left:472pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEDESC)) echo $viefeeChallandesc[3]->FEEDESC?></span>
<span style="position:absolute;top:290pt;left:640pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEAMOUNT)) echo $viefeeChallandesc[3]->FEEAMOUNT?></span>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:304pt;left:472pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo 'Fine Amount'?></span>
<span style="position:absolute;top:304pt;left:646pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo $viewfeeInfo[0]->FINEAMOUNT?></span>
<div style="position:absolute;top:252.0pt;left:611.5pt;width:2.8;height:72.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div><?php } ?>
<span style="position:absolute;top:320pt;left:636pt" id=f12>
  <?php 
  if(isset($viefeeChallandesc[0]->FEEAMOUNT) && isset($viefeeChallandesc[1]->FEEAMOUNT) && isset($viefeeChallandesc[2]->FEEAMOUNT) && isset($viefeeChallandesc[3]->FEEAMOUNT)){
  $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; 
  echo $total;
  }else if(isset($viefeeChallandesc[0]->FEEAMOUNT) && isset($viefeeChallandesc[0]->FEEAMOUNT)){
...
<span style="position:absolute;top:320pt;left:535pt" id=f12>Total Amount:</span>
...
<div style="position:absolute;top:238.5pt;left:827.5pt;width:2.8;height:72.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
...
<div style="position:absolute;top:277.0pt;left:684.0pt;width:259.1;height:19.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
...
<span style="position:absolute;top:252pt;left:688pt" id=f6>
  <?php echo isset($viefeeChallandesc[0]->FEEDESC)?$viefeeChallandesc[0]->FEEDESC:''; ?>    
</span>
<span style="position:absolute;top:252pt;left:856pt" id=f6>
  <?php 
  echo $viefeeChallandesc[0]->FEEAMOUNT
  ?>
    
  </span>
<span style="position:absolute;top:265pt;left:688pt" id=f6>

  <?php echo isset($viefeeChallandesc[1]->FEEDESC)?$viefeeChallandesc[1]->FEEDESC:''; ?></span>

<span style="position:absolute;top:265pt;left:861pt" id=f6>

  <?php echo isset($viefeeChallandesc[1]->FEEAMOUNT)?$viefeeChallandesc[1]->FEEAMOUNT:''; ?>
    
  </span>

<span style="position:absolute;top:278pt;left:688pt" id=f6>

  <?php echo isset($viefeeChallandesc[2]->FEEDESC)?$viefeeChallandesc[2]->FEEDESC:''; ?>
    
  </span>
<span style="position:absolute;top:278pt;left:856pt" id=f6>

  <?php echo isset($viefeeChallandesc[2]->FEEAMOUNT)?$viefeeChallandesc[2]->FEEAMOUNT:''; ?>
    
  </span>
<span style="position:absolute;top:290pt;left:688pt" id=f6>
  <?php 

  echo isset($viefeeChallandesc[3]->FEEDESC)?$viefeeChallandesc[3]->FEEDESC:'';

  ?>
    
  </span>
<span style="position:absolute;top:290pt;left:856pt" id=f6>
  <?php 
  echo isset($viefeeChallandesc[3]->FEEAMOUNT)?$viefeeChallandesc[3]->FEEAMOUNT:'';

  ?>
    
  </span>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:304pt;left:688pt" id=f6><?php echo 'Fine Amount'?></span>
<span style="position:absolute;top:304pt;left:862pt" id=f6><?php echo $viewfeeInfo[0]->FINEAMOUNT?></span>
<div style="position:absolute;top:252.0pt;left:827.5pt;width:2.8;height:68.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
<span style="position:absolute;top:320pt;left:852pt" id=f12>
...
<span style="position:absolute;top:320pt;left:755pt" id=f12>Total Amount:</span>
