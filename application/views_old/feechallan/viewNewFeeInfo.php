<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View Hostel New Student Fee Structure Management
        <small>View</small>
      </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                 <a style="float:left !important" class="btn btn-default" href="<?php echo base_url(); ?>feechallan/Feechallan/viewhostelNewfeestructure">Back</a>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">View Hostel New Student Fee Structure List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
              ...
              <thead>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="<?php echo base_url().'feechallan/Feechallan/EditNewFeeStructure/'.$record->id ?>"><i class="fa fa-pencil"></i>&nbsp;&nbsp;&nbsp;</a>
