...
<div style="position:absolute;top:225.0pt;left:179.5pt;width:2.8;height:58.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<?php } else {?>
...
<?php } ?>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) { ?>
<span style="position:absolute;top:289pt;left:204pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT) && isset($viefeeChallandesc[1]->FEEAMOUNT)) $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT; echo $total;?></span>
<?php } else {?>
...
<div style="position:absolute;top:225.0pt;left:395.5pt;width:2.8;height:39.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
...
<span style="position:absolute;top:289pt;left:420pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT))$total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT; echo $total?></span>
<?php } 
else {
?>
...
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<div style="position:absolute;top:224.5pt;left:611.5pt;width:2.8;height:60.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div><?php } else {?>
...
<?php if(isset($viefeeChallandesc[2]->FEEAMOUNT)) {?>
<span style="position:absolute;top:289pt;left:636pt" id=f12><?php $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT; echo $total?></span> <?php }else {?>
...
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<div style="position:absolute;top:224.5pt;left:827.5pt;width:2.8;height:60.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<?php }else {?>
...
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<span style="position:absolute;top:289pt;left:852pt" id=f12><?php $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT; echo $total?></span>
<?php }else {?>
