...
<div style="position:absolute;top:277pt;left:36.0pt;width:259.1;height:16.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
...
<span style="position:absolute;top:278pt;left:212pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEAMOUNT)) echo $viefeeChallandesc[3]->FEEAMOUNT?></span>
...
<div style="position:absolute;top:225.0pt;left:179.5pt;width:2.8;height:73.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<?php } else {?>
<div style="position:absolute;top:225.0pt;left:179.5pt;width:2.8;height:37.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div> <?php }?>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
...
<?php } ?>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) { ?>
<span style="position:absolute;top:300pt;left:204pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT) && isset($viefeeChallandesc[1]->FEEAMOUNT)) $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT; echo $total;?></span>
<?php } else {?>
<span style="position:absolute;top:289pt;left:204pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT) && isset($viefeeChallandesc[1]->FEEAMOUNT)) $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total;?></span>
<?php }?>
<span style="position:absolute;top:300pt;left:103pt" id=f12>Total Amount:</span>
...
<div style="position:absolute;top:225.0pt;left:395.5pt;width:2.8;height:72.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
...
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:277.0pt;left:252.0pt;width:259.1;height:16.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
...
<span style="position:absolute;top:278pt;left:428pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEAMOUNT)) echo $viefeeChallandesc[3]->FEEAMOUNT?></span>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) { ?>
...
<?php }?>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:290pt;left:256pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo 'Fine Amount'?></span>
<span style="position:absolute;top:290pt;left:430pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo $viewfeeInfo[0]->FINEAMOUNT?></span>
...
<span style="position:absolute;top:300pt;left:420pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT))$total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT; echo $total?></span>
<?php } 
else {
?>
<span style="position:absolute;top:289pt;left:420pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT))$total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total;?></span>
<?php } ?>
<span style="position:absolute;top:300pt;left:325pt" id=f12>Total Amount:</span>
...
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<div style="position:absolute;top:224.5pt;left:611.5pt;width:2.8;height:76.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div><?php } else {?>
...
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:290.0pt;left:468.0pt;width:259.1;height:1.0;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div><?php } ?>
...
<span style="position:absolute;top:279pt;left:644pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEAMOUNT)) echo $viefeeChallandesc[3]->FEEAMOUNT?></span>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
...
<?php }?>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:292pt;left:472pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo 'Fine Amount'?></span>
<span style="position:absolute;top:292pt;left:646pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo $viewfeeInfo[0]->FINEAMOUNT?></span>
...
<?php if(isset($viefeeChallandesc[2]->FEEAMOUNT)) {?>
<span style="position:absolute;top:302pt;left:636pt" id=f12><?php $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT; echo $total?></span> <?php }else {?>
<span style="position:absolute;top:289pt;left:636pt" id=f12><?php $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total?></span>
<?php }?>
...
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<div style="position:absolute;top:224.5pt;left:827.5pt;width:2.8;height:75.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<?php }else {?>
...
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:289.0pt;left:684.0pt;width:259.1;height:1.0;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div><?php } ?>
...
<span style="position:absolute;top:279pt;left:861pt" id=f6><?php echo $viefeeChallandesc[3]->FEEAMOUNT?></span>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<span style="position:absolute;top:265pt;left:688pt" id=f6><?php echo $viefeeChallandesc[2]->FEEDESC?></span>
<span style="position:absolute;top:265pt;left:861pt" id=f6><?php echo $viefeeChallandesc[2]->FEEAMOUNT?></span>
<?php }?>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
...
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<span style="position:absolute;top:300pt;left:852pt" id=f12><?php $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT; echo $total?></span>
<?php }else {?>
<span style="position:absolute;top:300pt;left:852pt" id=f12><?php $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total?></span>
<?php }?>
<span style="position:absolute;top:300pt;left:755pt" id=f12>Total Amount:</span>
