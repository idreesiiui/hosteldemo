<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        New Fee Challan Regno Wise Management
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter New Fee Challan Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" id="addUser" action="<?php echo base_url() ?>feechallan/Feechallan/SubmitNewFeeChallanregno" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                               ...
                               <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="assignfeestruc" name="assignfeestruc" required>
                                            ...
                                            <option value="SPR-2022">SPR-2022</option>
                                            <?php
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="gender">Hostel Utility Charges(Amount)</label>
                                       <input type="number" class="form-control" id="utilityfee" name="utilityfee">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="role">Fee Challan Type</label>
                                       <input type="text" class="form-control required" id="feetype" name="feetype" value="<?php echo 'NEW HOSTEL FEE' ?>" readonly required>
                                    </div>
                                </div>      
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="gender">Hostel Reservation Charges(Amount)</label>
                                       <input type="number" class="form-control" name="reservefee">
                                    </div>
                                </div>     
                            </div>
                        </div><!-- /.box-body -->
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-primary" style="background-color:#3C8DBC; float:right" href="<?php echo base_url(); ?>feechallan/Feechallan/viewAllFeechallanregno">Back</a>
                        </div>
                    </form>
                </div>
            </div>
