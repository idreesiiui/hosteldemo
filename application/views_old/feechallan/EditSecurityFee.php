              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Security Fee Challan Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" id="addUser" action="<?php echo base_url() ?>feechallan/Feechallan/updateSecurityFeeChallan" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="role">Security Fee Amount</label>
                                        <input type="number" class="form-control required" id="secamount" name="secamount" maxlength="100" value="<?php echo $securityamount[0]->FEEAMOUNT?>">
                                    </div>
                                </div>      
                            </div>
                            <div class="row">
