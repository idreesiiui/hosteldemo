...
<span style="position:absolute;top:202pt;left:36pt" id=f7>Batchxxxx:</span>
<span style="position:absolute;top:202pt;left:63pt" id=f11> <?php echo $viewfeeInfo[0]->BATCHNAME?></span>
...
<div style="position:absolute;top:224.5pt;left:36.0pt;width:259.1;height:5.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
...
<span style="position:absolute;top:226pt;left:40pt" id=f12>Particulars</span>
<span style="position:absolute;top:226pt;left:188pt" id=f12>Amount</span>
...
<div style="position:absolute;top:277.0pt;left:36.0pt;width:259.1;height:19.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>

<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:288pt;left:36.0pt;width:259.1;height:16.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>

<span style="position:absolute;top:240pt;left:40pt" id=f6><?php if(isset($viefeeChallandesc[0]->FEEDESC)) echo $viefeeChallandesc[0]->FEEDESC?></span>
<span style="position:absolute;top:240pt;left:208pt" id=f6><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT)) echo $viefeeChallandesc[0]->FEEAMOUNT?></span>
<span style="position:absolute;top:253pt;left:40pt" id=f6><?php  if(isset($viefeeChallandesc[1]->FEEDESC)) echo $viefeeChallandesc[1]->FEEDESC?></span>
<span style="position:absolute;top:253pt;left:212pt" id=f6><?php if(isset($viefeeChallandesc[1]->FEEAMOUNT)) echo $viefeeChallandesc[1]->FEEAMOUNT?></span>
<span style="position:absolute;top:278pt;left:40pt" id=f6><?php  if(isset($viefeeChallandesc[3]->FEEDESC)) echo $viefeeChallandesc[3]->FEEDESC?></span>
<span style="position:absolute;top:290pt;left:40pt" id=f6><?php  if(isset($viefeeChallandesc[4]->FEEDESC)) echo $viefeeChallandesc[4]->FEEDESC?></span>
<span style="position:absolute;top:278pt;left:209pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEAMOUNT)) echo $viefeeChallandesc[3]->FEEAMOUNT?></span>
<span style="position:absolute;top:290pt;left:209pt" id=f6><?php if(isset($viefeeChallandesc[4]->FEEAMOUNT)) echo $viefeeChallandesc[4]->FEEAMOUNT?></span>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) 
 { ?>
 <span style="position:absolute;top:265pt;left:40pt" id=f6><?php  if(isset($viefeeChallandesc[2]->FEEDESC)) echo $viefeeChallandesc[2]->FEEDESC?></span>
<span style="position:absolute;top:265pt;left:212pt" id=f6><?php if(isset($viefeeChallandesc[2]->FEEAMOUNT)) echo $viefeeChallandesc[2]->FEEAMOUNT?></span>
<div style="position:absolute;top:238.0pt;left:179.5pt;width:2.8;height:73.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<?php } else {?>
<div style="position:absolute;top:238.0pt;left:179.5pt;width:2.8;height:37.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div> <?php }?>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:300pt;left:40pt" id=f6><?php  if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo 'Fine Amount'?></span>
<span style="position:absolute;top:300pt;left:214pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo $viewfeeInfo[0]->FINEAMOUNT?></span>
<div style="position:absolute;top:252.0pt;left:179.5pt;width:2.8;height:52.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<?php } ?>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) { ?>
<span style="position:absolute;top:315pt;left:204pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT) && isset($viefeeChallandesc[1]->FEEAMOUNT)) $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viefeeChallandesc[4]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT; echo $total;?></span>
<?php } else {?>
<span style="position:absolute;top:315pt;left:204pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT) && isset($viefeeChallandesc[1]->FEEAMOUNT)) $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viefeeChallandesc[4]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total;?></span>
<?php }?>
<span style="position:absolute;top:315pt;left:103pt" id=f12>Total Amount:</span>
<div style="position:absolute;top:358.0pt;left:247.5pt;width:265.5;height:2.8;padding-top:-4.8;font:0pt Arial;border-width:1.4 0 0 0; border-style:solid;border-color:#000000;"></div>
<style>#f13{font:10pt Arial;color:#000000}</style>
<span style="position:absolute;top:360pt;left:162pt" id=f13>Cashier(Bank)</span>
<span style="position:absolute;top:360pt;left:31pt" id=f13>Officer (FeeSection)</span>
...
<div style="position:absolute;top:224.5pt;left:252.0pt;width:259.1;height:5.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
...
<span style="position:absolute;top:226pt;left:256pt" id=f12>Particulars</span>
<span style="position:absolute;top:226pt;left:404pt" id=f12>Amount</span>
<div style="position:absolute;top:225.0pt;left:395.5pt;width:2.8;height:86.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
...
<div style="position:absolute;top:277.0pt;left:252.0pt;width:259.1;height:1.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
<div style="position:absolute;top:288.0pt;left:252.0pt;width:259.1;height:1.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:288.0pt;left:252.0pt;width:259.1;height:16.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
<span style="position:absolute;top:240pt;left:256pt" id=f6><?php if(isset($viefeeChallandesc[0]->FEEDESC)) echo $viefeeChallandesc[0]->FEEDESC?></span>
<span style="position:absolute;top:240pt;left:424pt" id=f6><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT)) echo $viefeeChallandesc[0]->FEEAMOUNT?></span>
<span style="position:absolute;top:253pt;left:256pt" id=f6><?php if(isset($viefeeChallandesc[1]->FEEDESC)) echo $viefeeChallandesc[1]->FEEDESC?></span>
<span style="position:absolute;top:253pt;left:428pt" id=f6><?php if(isset($viefeeChallandesc[1]->FEEAMOUNT)) echo $viefeeChallandesc[1]->FEEAMOUNT?></span>
<span style="position:absolute;top:278pt;left:256pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEDESC)) echo $viefeeChallandesc[3]->FEEDESC?></span>
<span style="position:absolute;top:278pt;left:425pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEAMOUNT)) echo $viefeeChallandesc[3]->FEEAMOUNT?></span>
<span style="position:absolute;top:289pt;left:256pt" id=f6><?php if(isset($viefeeChallandesc[4]->FEEDESC)) echo $viefeeChallandesc[4]->FEEDESC?></span>
<span style="position:absolute;top:289pt;left:425pt" id=f6><?php if(isset($viefeeChallandesc[4]->FEEAMOUNT)) echo $viefeeChallandesc[4]->FEEAMOUNT?></span>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) { ?>
<span style="position:absolute;top:265pt;left:256pt" id=f6><?php if(isset($viefeeChallandesc[2]->FEEDESC)) echo $viefeeChallandesc[2]->FEEDESC?></span>
<span style="position:absolute;top:265pt;left:428pt" id=f6><?php if(isset($viefeeChallandesc[2]->FEEAMOUNT)) echo $viefeeChallandesc[2]->FEEAMOUNT?></span>
<div style="position:absolute;top:264.0pt;left:395.5pt;width:2.8;height:5.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<?php }?>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:300pt;left:256pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo 'Fine Amount'?></span>
<span style="position:absolute;top:300pt;left:430pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo $viewfeeInfo[0]->FINEAMOUNT?></span>
<div style="position:absolute;top:265.0pt;left:395.5pt;width:2.8;height:33.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
<?php if(isset($viefeeChallandesc[2]->FEEAMOUNT)) {?>
<span style="position:absolute;top:315pt;left:420pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT))$total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viefeeChallandesc[4]->FEEAMOUNT; echo $total?></span>
<?php } 
else {
?>
<span style="position:absolute;top:289pt;left:420pt" id=f12><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT))$total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viefeeChallandesc[4]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total;?></span>
<?php } ?>
<span style="position:absolute;top:315pt;left:325pt" id=f12>Total Amount:</span>
<div style="position:absolute;top:358.0pt;left:31.5pt;width:265.5;height:2.8;padding-top:-4.8;font:0pt Arial;border-width:1.4 0 0 0; border-style:solid;border-color:#000000;"></div>
<span style="position:absolute;top:360pt;left:378pt" id=f13>Cashier(Bank)</span>
<span style="position:absolute;top:360pt;left:247pt" id=f13>Officer(FeeSection)</span>
...
<div style="position:absolute;top:224.5pt;left:468.0pt;width:259.1;height:5.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
...
<span style="position:absolute;top:226pt;left:472pt" id=f12>Particulars</span>
<span style="position:absolute;top:226pt;left:620pt" id=f12>Amount</span>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<div style="position:absolute;top:224.5pt;left:611.5pt;width:2.8;height:92.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div><?php } else {?>
<div style="position:absolute;top:224.5pt;left:611.5pt;width:2.8;height:40.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div> <?php }?>
...
<div style="position:absolute;top:277.0pt;left:468.0pt;width:259.1;height:3.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
<div style="position:absolute;top:290.0pt;left:468.0pt;width:259.1;height:3.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:303.0pt;left:468.0pt;width:259.1;height:1.0;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div><?php } ?>
<span style="position:absolute;top:240pt;left:472pt" id=f6><?php if(isset($viefeeChallandesc[0]->FEEDESC)) echo $viefeeChallandesc[0]->FEEDESC?></span>
<span style="position:absolute;top:240pt;left:640pt" id=f6><?php if(isset($viefeeChallandesc[0]->FEEAMOUNT)) echo $viefeeChallandesc[0]->FEEAMOUNT?></span>
<span style="position:absolute;top:253pt;left:472pt" id=f6><?php if(isset($viefeeChallandesc[1]->FEEDESC)) echo $viefeeChallandesc[1]->FEEDESC?></span>
<span style="position:absolute;top:253pt;left:644pt" id=f6><?php if(isset($viefeeChallandesc[1]->FEEAMOUNT)) echo $viefeeChallandesc[1]->FEEAMOUNT?></span>
<span style="position:absolute;top:279pt;left:472pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEDESC)) echo $viefeeChallandesc[3]->FEEDESC?></span>
<span style="position:absolute;top:292pt;left:472pt" id=f6><?php if(isset($viefeeChallandesc[4]->FEEDESC)) echo $viefeeChallandesc[4]->FEEDESC?></span>
<span style="position:absolute;top:279pt;left:641pt" id=f6><?php if(isset($viefeeChallandesc[3]->FEEAMOUNT)) echo $viefeeChallandesc[3]->FEEAMOUNT?></span>
<span style="position:absolute;top:292pt;left:641pt" id=f6><?php if(isset($viefeeChallandesc[4]->FEEAMOUNT)) echo $viefeeChallandesc[4]->FEEAMOUNT?></span>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<span style="position:absolute;top:265pt;left:472pt" id=f6><?php if(isset($viefeeChallandesc[2]->FEEDESC)) echo $viefeeChallandesc[2]->FEEDESC?></span>
<span style="position:absolute;top:265pt;left:644pt" id=f6><?php if(isset($viefeeChallandesc[2]->FEEAMOUNT)) echo $viefeeChallandesc[2]->FEEAMOUNT?></span>

<?php }?>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:303pt;left:472pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo 'Fine Amount'?></span>
<span style="position:absolute;top:303pt;left:646pt" id=f6><?php if(isset($viewfeeInfo[0]->FINEAMOUNT)) echo $viewfeeInfo[0]->FINEAMOUNT?></span>
<div style="position:absolute;top:252.0pt;left:611.5pt;width:2.8;height:54.5;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div><?php } ?>
<?php if(isset($viefeeChallandesc[2]->FEEAMOUNT)) {?>
<span style="position:absolute;top:317pt;left:636pt" id=f12><?php $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viefeeChallandesc[4]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT; echo $total?></span> <?php }else {?>
<span style="position:absolute;top:289pt;left:636pt" id=f12><?php $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viefeeChallandesc[4]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total?></span>
<?php }?>
<span style="position:absolute;top:317pt;left:535pt" id=f12>Total Amount:</span>
<div style="position:absolute;top:358.0pt;left:463.5pt;width:265.5;height:2.8;padding-top:-4.8;font:0pt Arial;border-width:1.4 0 0 0; border-style:solid;border-color:#000000;"></div>
<span style="position:absolute;top:360pt;left:594pt" id=f13>Cashier(Bank)</span>
<span style="position:absolute;top:360pt;left:463pt" id=f13>Officer(FeeSection)</span>
...
<div style="position:absolute;top:224.5pt;left:684.0pt;width:259.1;height:5.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
...
<span style="position:absolute;top:226pt;left:688pt" id=f12>Particulars</span>
<span style="position:absolute;top:226pt;left:836pt" id=f12>Amount</span>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<div style="position:absolute;top:224.5pt;left:827.5pt;width:2.8;height:92.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div>
<?php }else {?>
...
<div style="position:absolute;top:277.0pt;left:684.0pt;width:259.1;height:2.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
<div style="position:absolute;top:289.0pt;left:684.0pt;width:259.1;height:2.5;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<div style="position:absolute;top:301.0pt;left:684.0pt;width:259.1;height:1.0;padding-top:11.8;font:0pt Arial;border-width:1.4; border-style:solid;border-color:#000000;"></div><?php } ?>
<span style="position:absolute;top:240pt;left:688pt" id=f6><?php echo $viefeeChallandesc[0]->FEEDESC?></span>
<span style="position:absolute;top:240pt;left:856pt" id=f6><?php echo $viefeeChallandesc[0]->FEEAMOUNT?></span>
<span style="position:absolute;top:253pt;left:688pt" id=f6><?php echo $viefeeChallandesc[1]->FEEDESC?></span>
<span style="position:absolute;top:253pt;left:861pt" id=f6><?php echo $viefeeChallandesc[1]->FEEAMOUNT?></span>
<span style="position:absolute;top:279pt;left:688pt" id=f6><?php echo $viefeeChallandesc[3]->FEEDESC?></span>
<span style="position:absolute;top:279pt;left:857pt" id=f6><?php echo $viefeeChallandesc[3]->FEEAMOUNT?></span>
<span style="position:absolute;top:292pt;left:688pt" id=f6><?php echo $viefeeChallandesc[4]->FEEDESC?></span>
<span style="position:absolute;top:292pt;left:857pt" id=f6><?php echo $viefeeChallandesc[4]->FEEAMOUNT?></span>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<span style="position:absolute;top:265pt;left:688pt" id=f6><?php echo $viefeeChallandesc[2]->FEEDESC?></span>
<span style="position:absolute;top:265pt;left:859pt" id=f6><?php echo $viefeeChallandesc[2]->FEEAMOUNT?></span>
<?php }?>
<?php if($viewfeeInfo[0]->FINEAMOUNT != 0) {?>
<span style="position:absolute;top:302pt;left:688pt" id=f6><?php echo 'Fine Amount'?></span>
<span style="position:absolute;top:302pt;left:862pt" id=f6><?php echo $viewfeeInfo[0]->FINEAMOUNT?></span>
<div style="position:absolute;top:252.0pt;left:827.5pt;width:2.8;height:53.0;padding-top:11.8;font:0pt Arial;border-width:0 0 0 1.4; border-style:solid;border-color:#000000;"></div> <?php } ?>
<?php if(isset($viefeeChallandesc[2]->FEEDESC)) {?>
<span style="position:absolute;top:317pt;left:852pt" id=f12><?php $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viefeeChallandesc[4]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT+$viefeeChallandesc[2]->FEEAMOUNT; echo $total?></span>
<?php }else {?>
<span style="position:absolute;top:317pt;left:852pt" id=f12><?php $total = $viefeeChallandesc[0]->FEEAMOUNT+$viefeeChallandesc[1]->FEEAMOUNT+$viefeeChallandesc[3]->FEEAMOUNT+$viefeeChallandesc[4]->FEEAMOUNT+$viewfeeInfo[0]->FINEAMOUNT; echo $total?></span>
<?php }?>
<span style="position:absolute;top:317pt;left:755pt" id=f12>Total Amount:</span>
<div style="position:absolute;top:358.0pt;left:679.0pt;width:265.5;height:2.8;padding-top:-4.8;font:0pt Arial;border-width:1.4 0 0 0; border-style:solid;border-color:#000000;"></div>
<span style="position:absolute;top:360pt;left:679pt" id=f13>Officer(FeeSection)</span>
<span style="position:absolute;top:360pt;left:810pt" id=f13>Cashier(Bank)</span>
