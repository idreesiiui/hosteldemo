    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><img src="<?php echo base_url() ?>/assets/images/Iiui-logo1.jpg" style="width:100px; height:100px"> Online Application for Hostel Seat Change</h4>
          <h5> Seat Change for <?php echo "<b>(".$semestercode[0]->PROGRAME." ) ".$semestercode[0]->SEMCODE."</b>".' and before'; ?></h5>
          ...
          <p style="color:red">Registration open on Friday, March 29, 2018 at 9:00 am and will be closed on March 29, 2018 at 3:00 pm. For more Information <a href="../../form/seatchange/seat-change-260319.jpg">Click here</a> </p>
          <div class="col-md-4">
                <?php
       ...
       <?php $this->load->helper('form'); ?>
        ...
        <div class="modal-body">
         <form role="form" action="<?php echo base_url() ?>regbox/getmalestudentSeatInter" method="post" id="regbox">
          <div class="row">
                                <div class="col-md-6">                                
