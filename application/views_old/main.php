    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <?php $this->load->helper('form'); ?>
        ...
        </div> <!--action="<?php //echo base_url();?>regbox/getregdetails"  regbox/malecampus-->
        	...
        	<div class="modal-footer">
             <div class="col-md-4" text-left">
              <div class="form-group">
                                       <a href="<?php echo base_url() ?>regbox/malemain"><button type="button" class="btn btn-block btn-primary">MALE CAMPUS</button></a>
                  </div>
                 </div>
         
                  <div class="col-md-4" text-right">
                 <div class="form-group">
<a href="<?php echo base_url() ?>regbox/femalecampus"><button type="button" class="btn btn-block btn-primary">FEMALE CAMPUS</button></a>
                 </div>
                    </div>
                    <div class="col-md-4" text-right">
                 <div class="form-group">
<a href="<?php echo base_url() ?>login"><button type="button" class="btn btn-block btn-primary">User Login</button></a>
                 </div>
                    </div>
              </div>
      </div>
