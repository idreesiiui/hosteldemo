                    ...
                    <!-- form start -->
                     ...
                     <form role="form" id="hostel" action="<?php echo base_url() ?>hostel/hostel/editHostel" method="post" role="form">
                            ...
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="hostelno" name="hostelno" maxlength="10" value="<?php echo  $hostelno?>">
                        ...
                        <div class="box-footer">
                            <input type="submit" class="btn btn-primary" value="Update Hostel" />
