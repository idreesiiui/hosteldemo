	...
	<div class="collapse navbar-collapse m-2" id="navbarNavDropdown-1">
		<ul class="navbar-nav mr-auto">
			...
			<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				<a class="dropdown-item" href="<?php echo base_url();?>allotlistfemale">New Allotment (Application)</a>
                <a class="dropdown-item" href="<?php echo base_url();?>reallotlistfemale">Re-Allotment (Application)</a>
                <a class="dropdown-item" href="<?php echo base_url();?>seatlistfemale">Seat Change (Application)</a>
            </div></li>
			...
			<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				<a class="dropdown-item" href="<?php echo base_url();?>generalnotificationfemale">General Notice</a>
                <a class="dropdown-item" href="<?php echo base_url();?>allotnotificationfemale">New Allotment (Application)</a>
                <a class="dropdown-item" href="<?php echo base_url();?>reallotnotificationfemale">Re-Allotment (Application)</a>
                <a class="dropdown-item" href="<?php echo base_url();?>seatnotificationfemale">Seat Change (Application)</a>
            </div></li>
		    ...
		    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
	          ...
	          <a class="dropdown-item" href="<?php echo base_url();?>stepguideR">Step Guide (Reallotment)</a>
...
HEADER
--------------------------------------->
<div class="jumbotron jumbotron-md jumbotron-fluid mb-3 bg-light" style="background-image: url('<?php echo base_url();?>/assets/frontend/img/usis/headerfemale.png');background-size:cover;">
	<div class="container text-dark h-100 tofront">
		<div class="row align-items-center justify-content-center text-center text-white mt-5">
			<div class="col-md-10">
				<h1 class="display-3"><?php echo $campus; ?> Hostel General Notice</h1>
            </div>
		</div>
	</div>
</div>
...
<tr>
	<th scope="row"> 1	</th>
	<td> Revised Schedule Hostel Seats Allotment </td>
	<td> 26-09-2019 </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/general/allotment-270919.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
<tr>
	<th scope="row"> 2 </th>
	<td> Tentative Hostel Activities Schedule – Fall 2019 Semester </td>
	<td> 03-09-2019 </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/general/schedule-030919.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
</tbody>
</table>
<!-- End Main -->
...
<div class="container">
	<div class="row  mb-1">
		<div class="col-md-3">
			<h4 class="mb-1 text-white">Female List <small class="blink text-warning" style="font-size:14px">(New) </small></h4>
            <hr class="footer-menu mb-3">
			<ul class="list-unstyled text-small text-success">
				<li>
			      <a class="text-gray" href="<?php echo base_url();?>allotlistfemale"><i class="fa fa-list text-success"></i> New Allotement</a></li>
			      <li><a class="text-gray" href="<?php echo base_url();?>reallotlistfemale"><i class="fa fa-list text-success"></i> Re-Allotemnt</a></li>
			      <li><a class="text-gray" href="<?php echo base_url();?>seatlistfemale"><i class="fa fa-list text-success"></i> Seat Change / Interchange</a>
			    </li>
			</ul>
		</div>
		<div class="col-md-3">
			...
			<ul class="list-unstyled text-small">
				...
				<li><p class="text-gray"><i class="fas fa-envelope text-success"></i> hostelfemale@iiu.edu.pk</p></li>
			</ul>
		</div>
		<div class="col-md-3">
