...
<div class="d-md-flex h-md-100 align-items-center">
			...
			<div class="logoarea pt-5 pb-3">
				...
				<div class="instruction bg-white text-danger border shadow rounded p-1">
					...
					<ul class="text-left">
                        ...
                        <li>Enter Email as per Hostel Card <span class="font-weight-bold">(OR) </span></li>
	...
	<div class="col-md-6 p-0 bg-white h-md-100 loginarea">
		<div class="d-md-flex align-items-center h-md-100 p-4 justify-content-center">
			<form action="<?php echo base_url();?>systemlogin" method="post" id="signupForm" class="border  rounded p-4"
             style="min-width: 50%;">
		    ...
		    <?php } ?>
				<div class="form-group">
                	<input type="text" class="form-control" id="user"  name="user" placeholder="Email / Reg. No  / CNIC" required="">
				</div>
				<div class="form-group">
