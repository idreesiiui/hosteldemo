...
<div class="jumbotron jumbotron-md jumbotron-fluid mb-3 bg-light" style="background-image: url('<?php echo base_url();?>/assets/frontend/img/usis/headermale.png');background-size:cover;">
	<div class="container text-dark h-100 tofront">
		<div class="row align-items-center justify-content-center text-center text-white mt-5">
			<div class="col-md-10">
				<h1 class="display-3">Mess Fee Deposit Rules <?php echo $campus; ?> Hostel</h1>
            </div>
		</div>
	</div>
</div>
...
<!-- table -->
<div class="bg-white">
<h2 class="bg-white text-success font-weight-bold text-center">Mess Fee Deposit Rules</h2>
...
<tr>
	...
	<td> 31-08-2018 </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/mess/mess-fee-september-2018-310818.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
<tr>
	<th scope="row"> 2	</th>
	<td> August 2018 </td>
	<td> 01-08-2018 </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/mess/mess-fee-august-2018-010818.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
<tr>
	<th scope="row"> 3	</th>
	<td> July – 10 August 2018 </td>
	<td> 29-06-2018 </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/mess/Mess-Fee-July-August-2018-290618.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
<tr>
	<th scope="row"> 4	</th>
	<td> November 2017 </td>
	<td> 10-11-2017 </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/mess/Mess-Fee-November-17-101117.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
<tr>
	<th scope="row"> 5	</th>
	<td> August 2017 </td>
	<td> 09-08-2017 </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/mess/Mess-Fee-August-17-090817.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
</tbody>
</table>
</div>
