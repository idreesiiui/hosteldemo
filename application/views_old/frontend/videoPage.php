...
<div class="row m-2 bg-white">
    ...
    <div class="pt-2 pb-2 col-md-12  card bg-white overlay overlay-white text-white border-white"> <div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h3 class="card-title">Forget Password</h3>
                <p class="card-text">
                     Recover your Account.
                </p>
                <video style="border:2px solid black;" width="780" height="400"controls>
                  <source src="<?php echo base_url();?>/videos/Forget Password.mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
    
    <div class="pt-2 pb-2 col-md-12  card bg-white overlay overlay-white text-white  border-white" > 
        <div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                ...
                <video style="border:2px solid black;" width="797" height="400"controls>
                  <source src="<?php echo base_url();?>/videos/New Application.mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
    ...
    <div class="pt-2 pb-2 col-md-12  card bg-white overlay overlay-white text-white  border-white" > 
        <div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h3 class="card-title">New Allotment</h3>
                <p class="card-text">
                     Allotment of New Seat.
                </p>
                <video style="border:2px solid black;" width="800" height="400"controls>
                  <source src="<?php echo base_url();?>/videos/New Allotment.mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
    ...
    <div class="pt-2 pb-2 col-md-12  card bg-white overlay overlay-white text-white  border-white" > <div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                ...
                <video style="border:2px solid black;" width="800" height="400"controls>
                  <source src="<?php echo base_url();?>/videos/Reallotment.mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
