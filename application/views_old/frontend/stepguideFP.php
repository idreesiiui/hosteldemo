...
<div class="jumbotron jumbotron-md jumbotron-fluid mb-3 bg-light" style="background-image: url('<?php echo base_url();?>/assets/frontend/img/usis/headermale.png');background-size:cover;">
	<div class="container text-dark h-100 tofront">
		<div class="row align-items-center justify-content-center text-center text-white mt-5">
			<div class="col-md-10">
				<h1 class="display-3">Step Guide Forget Password</h1>
            </div>
		</div>
	</div>
</div>
...
<div class="row m-2 bg-white">
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 1: Forget Password</h4>
                <p class="card-text">
                     Incase of Forget Password Click on <b class="text-danger">Forget your Password?</b> Link.
                </p>
                  <img src="<?php echo base_url();?>uploads/screenshots/ForgetPassword/1.forgetPassword.png"/>
             </div>
        </div>
    </div>
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 2: Forget Password</h4>
                <p class="card-text">
                    On Forgot Password screen enter your <b class="text-danger">Registered Email Address</b> and click on <b class="text-danger">Reset</b> button.
                </p>
                <img src="<?php echo base_url();?>uploads/screenshots/ForgetPassword/2.forgetPassword.png"/>
            </div>
        </div>
    </div>
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 3: Forget Password</h4>
                <p class="card-text">
                     After Reset password System will redirect you to login screen and alert about <b class="text-danger">Check Email </b> for new password.
                </p>
                <img src="<?php echo base_url();?>uploads/screenshots/ForgetPassword/3.forgetPassword.png"/>
            </div>
        </div>
    </div>
    ...
    <div class="pt-3 pb-3 col-md-12  card overlay overlay-white text-white border-white"> 
    	<div class="d-flex align-items-center text-center">
            <div class="card-body text-dark">
                <h4 class="card-title ">Step 4: Forget Password</h4>
                <p class="card-text">
                     Login with the credientials <b class="text-danger"> (Email and Password)</b> mentioned in the email .
                </p>
                <img src="<?php echo base_url();?>uploads/screenshots/ForgetPassword/4.forgetPassword.png"/>
            </div>
        </div>
    </div>
