...
<div class="d-md-flex h-md-100 align-items-center">
		...
		<div class="text-white d-md-flex align-items-center h-100 p-5 text-center justify-content-center">
			<div class="logoarea pt-5 pb-5">
                ...
                <div class="instruction bg-white text-danger border shadow rounded p-1">
					...
					<ul class="text-left">
                    	<li>Enter your registered Email (at the time of new application)</li>
                        <li>OR Email you updated later</li>
                        <li>Auto Generated Password will be sent to Registered Email</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="col-md-6 p-0 bg-white h-md-100 loginarea">
		<div class="d-md-flex align-items-center h-md-100 p-4 justify-content-center" >
			<form action="<?php echo base_url();?>login/resetPasswordUser" method="post" id="forgotpwordForm" class="border rounded p-4"
             style="min-width: 50%;">
