...
<div class="jumbotron jumbotron-md jumbotron-fluid mb-3 bg-light" style="background-image: url('<?php echo base_url();?>/assets/frontend/img/usis/headerfemale.png');background-size:cover;">
	<div class="container text-dark h-100 tofront">
		<div class="row align-items-center justify-content-center text-center text-white mt-5">
			<div class="col-md-10">
				<h1 class="display-3"><?php echo $campus; ?> Hostel Seat Change</h1>
            </div>
		</div>
	</div>
</div>
...
<tr>
	<th scope="row"> 1	</th>
	<td> Revised Schedule Hostel Seats Change & Exchange </td>
	<td> 26-09-2019 </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/female/seatchange/seat-change-270919.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
</tbody>
</table>
<!-- End Main -->
