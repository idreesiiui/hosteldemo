...
<div class="jumbotron jumbotron-md jumbotron-fluid mb-3 bg-light" style="background-image: url('<?php echo base_url();?>/assets/frontend/img/usis/headermale.png');background-size:cover;">
	<div class="container text-dark h-100 tofront">
		<div class="row align-items-center justify-content-center text-center text-white mt-5">
			<div class="col-md-10">
				<h1 class="display-3">Contact Us <?php echo $campus; ?> Hostel</h1>
            </div>
		</div>
	</div>
</div>
...
<h2 class="bg-white text-success font-weight-bold text-center">Contact Us</h2>
<table class="bg-white table border" style="text-align: center;">
<thead class="bg-success text-white">
<tr>
	<th >#</th>
	<th align="center">Provost Girls Hostel Unit</th>
	<th >Phone</th>
...
<tr>
	<th scope="row"> 1	</th>
	<td> Dr.Humaira Ishfaq , Provost (Girls Hostels) </td>
	<td></td>
</tr>
<tr>
	<th scope="row"> 2	</th>
	<td> Ms Rubab Fatima, Deputy Director (Hostels) </td>
	<td> 9019301 </td>
</tr>
<tr>
	<th scope="row"> 3	</th>
	<td> Ms Nadia Malik , Assistant Director (Provost Office) </td>
	<td> 9019301 </td>
</tr>
<tr>
	<th scope="row"> 4	</th>
...
<tr>
	<th >#</th>
	<th align="center">In House Hostel Staff</th>
	<th >Phone</th>
...
<tr>
	<th scope="row"> 1	</th>
	<td>Ms Izzat Bagum, Assistant Lady Warden (A Block)</td>
	<td> 9019353 </td>
</tr>
<tr>
	<th scope="row"> 2	</th>
	<td>Ms Munawer Sultana, Assistant (A Block)</td>
	<td> 9019353 </td>
</tr>
<tr>
	<th scope="row"> 3	</th>
	<td>Ms RabiaMumtaz, Assistant Lady Warden (B block)</td>
	<td> 9019340 </td>
</tr>
<tr>
	<th scope="row"> 4	</th>
	<td>Ms Nabeela Sajjad, LDC (B Block)</td>
	<td> 9019340 </td>
</tr>
<tr>
	<th scope="row"> 5	</th>
	<td>Ms Noreen Kousar, Assistant Lady Warden (C Block)</td>
	<td> 9019356 </td>
</tr>
<tr>
	<th scope="row"> 6	</th>
	<td>Ms Nageena Shaheen, LDC (C Block)</td>
	<td> 9019356 </td>
</tr>
<tr>
	<th scope="row"> 7	</th>
	<td>Ms Aqsa Shabbir, Assistant Lady Warden (D block)</td>
	<td> 9019529 </td>
</tr>
<tr>
	<th scope="row"> 8	</th>
	<td>Ms Tanvir Fatima, LDC (D block)</td>
	<td> 9019529 </td>
</tr>
<tr>
	<th scope="row"> 9	</th>
	<td>Ms Salma Sadiq, Assistant Lady Warden (E Block)</td>
	<td> 9019085 </td>
</tr>
<tr>
	<th scope="row"> 10	</th>
	<td>Ms Saima Irum, LDC (E Block)</td>
	<td> 9019085 </td>
</tr>
<tr>
	<th scope="row"> 11	</th>
	<td>Ms Kouser Perveen , LDC (F block)</td>
	<td> 9019086 </td>
</tr>
<tr>
	<th scope="row"> 12	</th>
	<td>Ms Amna Shabbir, Assistant Lady Warden (G Block)</td>
	<td> 9019353 </td>
</tr>
<tr>
	<th scope="row">13	</th>
	<td>Ms Faiza Adnan, Assistant (G Block)</td>
	<td> 9019353 </td>
</tr>
</tbody>
<thead class="bg-success text-white">
<tr>
	<th >#</th>
	<th align="center">Focal Person</th>
	<th >Phone / Email</th>
...
<tr>
	<th scope="row"> 1	</th>
	<td> Ms Nadia Malik, Assistant Director Provost Office</td>
	<td> 051-9019879<br>051-9019301</td>
</tr>
<tr>
	<th scope="row"> 2	</th>
	<td > For any queries/further Information: provost.fc@iiu.edu.pk </td>
</tr>
</tbody>
</table>
</div>
