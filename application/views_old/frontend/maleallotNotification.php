	...
	<div class="collapse navbar-collapse m-2" id="navbarNavDropdown-1">
		<ul class="navbar-nav mr-auto">
			...
			<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="#">Renewalt</a>
...
<tr>
	<th scope="row"> 1	</th>
	<td> Waiting List – BS/Master Level </td>
	<td> 07-11-2019 </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/male/allotment/waiting-bs-mater-071119.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
<tr>
	<th scope="row"> 2	</th>
	<td> Allotment Notice BS/Master Level </td>
	<td> 07-11-2019 </td>
	<td><a href="<?php echo base_url();?>uploads/notifications/male/allotment/allotment-bs-mater-071119.jpg" target="_blank" rel="noopener noreferrer"><img src="<?php echo base_url();?>assets/frontend/img/usis/download.png" width=100 height=30 border="0" alt="Download"></a></td>
</tr>
</tbody>
</table>
<!-- End Main -->
