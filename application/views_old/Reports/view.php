<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Hostel Application List Report
        <small>View</small>
      </h1>
    </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Hostel Students Allotment List</h3>
              ...
              <div class="box-body">
                ...
                <form class="form-horizontal" id="searchList" name="validateform" method="post" action="<?php echo base_url() ?>report/reports/getuserlist" >
                  <div class="col-sm-2">
                    <select required class="form-control" name="programe" id="programe">
                  ...
                  <div class="col-sm-3">
                    ...
                    if(!empty($semester))
                    {
                        foreach ($semester as $semesters)
                        {
                            ?>
                            <option value="<?php 
                            echo $semesters->SEMCODE.','.$semesters->APPSTATUS;
                             ?>">
                                <?php if($semesters->APPSTATUS == 1)
                                {
                                    $status = 'New Application';
                                }else {
                                    $status = 'Re-Allotment';
                                }
                                echo $semesters->SEMCODE.' ('.$status.')' ?>
                            </option>
                            <?php
                        }
                    }
