<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Hostel Seat Change List Report
        <small>View</small>
      </h1>
    </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Hostel Students Seat Change List</h3>
                   
                    <form class="form-horizontal" id="searchList" name="validateform" method="post" action="<?php echo base_url() ?>report/reports/seatchanges" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    ...
                    <option value="">Select Hostle</option>
                    <?php
                        if(!empty($hostels))
                        {
                            ...
                            {
                                ?>
                                <option value="<?php echo $hostel->HOSTEL_NO ?>"><?php echo $hostel->HOSTELDESC ?></option>
                                <?php
                            }
                        }
                        ?>
